...
Details about the tables used in this analysis can be found in the [**Tables**](#Tables) section of the appendix. Additionally, the SQL code used to extract and process the data is provided in the [**SQL**](#SQLCode) Code section of the appendix below.
