...
Details about the tables used in this analysis can be found in the **Tables**(#appendix) section of the appendix. Additionally, the SQL code used to extract and process the data is provided in the **SQL Code** section of the appendix below.
